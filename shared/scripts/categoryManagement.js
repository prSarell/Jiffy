...
export function loadCategories(categoryRow) {
  ...
  const categories = storedData ? JSON.parse(storedData) : defaultCategories;
  ...
  categories.forEach((category, index) => {
    ...
    categoryDiv.innerHTML = `
      <button style="width: 40px; height: 40px; border-radius: 50%; cursor: pointer; border: none; position: relative;">
