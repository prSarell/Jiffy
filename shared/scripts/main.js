...
function initializeApp() {
  ...
  function showEditOptionsPopup(categoryDiv) {
    ...
    console.log('showEditOptionsPopup: editingCategoryDiv set to:', editingCategoryDiv);
    if (editOptionsPopup) {
  ...
  function closeEditOptionsPopup() {
    ...
    console.log('closeEditOptionsPopup: editingCategoryDiv before clearing:', editingCategoryDiv);
    editingCategoryDiv = null; // Clear the editing category
    console.log('closeEditOptionsPopup: editingCategoryDiv cleared:', editingCategoryDiv);
    if (editOptionsPopup) {
  ...
  function showEditColorPopup(categoryDiv) {
    ...
    editingCategoryDiv = categoryDiv; // Store the category being edited
    console.log('showEditColorPopup: editingCategoryDiv set to:', editingCategoryDiv);
  ...
  function closeEditColorPopup() {
    ...
    editingCategoryDiv = null; // Clear the editing category
    console.log('closeEditColorPopup: editingCategoryDiv cleared:', editingCategoryDiv);
  ...
  function showEditNamePopup(categoryDiv) {
    ...
    editingCategoryDiv = categoryDiv; // Store the category being edited
    console.log('showEditNamePopup: editingCategoryDiv set to:', editingCategoryDiv);
    if (editNamePopup) {
  ...
  function closeEditNamePopup() {
    ...
    editingCategoryDiv = null; // Clear the editing category
    console.log('closeEditNamePopup: editingCategoryDiv cleared:', editingCategoryDiv);
    if (editNamePopup) {
