...
<body style="background-color: #000000 !important; color: #FFFFFF !important; height: 100vh; display: flex; flex-direction: column; justify-content: flex-start; align-items: center; margin: 0; padding: 0; position: relative;">
  ...
  <div style="display: flex; flex-direction: column; align-items: center; margin-top: 30px;">
    ...
    <div style="display: flex; flex-wrap: wrap; justify-content: flex-start; align-items: center; gap: 20px; width: 240px;" class="category-row">
      <div style="display: flex; flex-direction: column; align-items: center; width: 40px; position: relative;">
        <button style="width: 40px; height: 40px; border-radius: 50%; background-color: #1E3A8A; cursor: pointer; border: none;" onclick="toggleSelect(this);"></button>
      ...
      <div style="display: flex; flex-direction: column; align-items: center; width: 40px; position: relative;">
        <button style="width: 40px; height: 40px; border-radius: 50%; background-color: #3B82F6; cursor: pointer; border: none;" onclick="toggleSelect(this);"></button>
        <span class="check-circle" style="display: none; position: absolute; top: 0; right: 0; width: 12px; height: 12px; border-radius: 50%; background-color: #FF4444;"></span>
        <span style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; font-size: 8px; margin-top: 5px;">Life</span>
      </div>
      <div style="display: flex; flex-direction: column; align-items: center; width: 40px; position: relative;">
        <button style="width: 40px; height: 40px; border-radius: 50%; background-color: #60A5FA; cursor: pointer; border: none;" onclick="toggleSelect(this);"></button>
        <span class="check-circle" style="display: none; position: absolute; top: 0; right: 0; width: 12px; height: 12px; border-radius: 50%; background-color: #FF4444;"></span>
        <span style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; font-size: 8px; margin-top: 5px;">Work</span>
      </div>
      <div style="display: flex; flex-direction: column; align-items: center; width: 40px; position: relative;">
        <button style="width: 40px; height: 40px; border-radius: 50%; background-color: #93C5FD; cursor: pointer; border: none;" onclick="toggleSelect(this);"></button>
        <span class="check-circle" style="display: none; position: absolute; top: 0; right: 0; width: 12px; height: 12px; border-radius: 50%; background-color: #FF4444;"></span>
  ...
  <div id="delete-popup" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.5); justify-content: center; align-items: center;">
    <div style="background: #C8E6C9; padding: 20px; border-radius: 8px; text-align: center; width: 80%; max-width: 300px;">
      <h2 id="delete-popup-message" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; font-size: 16px; margin: 0 0 10px;"></h2>
      <button id="delete-popup-cancel" style="background: #FFFFFF; color: #0057B7; border: 1px solid #0057B7; padding: 5px 10px; border-radius: 4px; margin-right: 5px; cursor: pointer;">Cancel</button>
      <button id="delete-popup-delete" style="background: #FF4444; color: #FFFFFF; border: none; padding: 5px 10px; border-radius: 4px; cursor: pointer;">Delete</button>
    </div>
  </div>
